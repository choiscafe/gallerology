...
User.create(name: "Cho", username: "choiscafe", password: "123A")
User.create(name: "Rafia", username: "Raf", password: "123B")
User.create(name: "Logan", username: "Meister", password: "123C")
...
Artist.create(name: "Andy Warhol", birthPlace: "PA, USA", activeYears: "1928-1987")
...
Artwork.create(image: "https://origins.osu.edu/sites/default/files/inline-images/andy-warhol-soup-cans.jpg", title: "Campbell's Soup Cans", year: 1961, gallery: "The Museum of Modern Art", exhibition: "Pop Art", notes: "An Array of soups", seenDate: "2021-04-24", artist_id: 3, user_id: 2)